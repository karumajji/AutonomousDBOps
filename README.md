[README.md](https://github.com/user-attachments/files/25078050/README.md)
...
The title will be the title on navigation panel on the left. The weight determines the order the page appears in the navigation panel. Test
